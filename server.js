...
const baseRewards=[{"name":"10K Yang","icon":"💵","type":"yang","amount":10000,"active":true,"min_qty":1,"max_qty":1,"chance":30.0},{"name":"100K Yang","icon":"💴","type":"yang","amount":100000,"active":true,"min_qty":1,"max_qty":1,"chance":24.0},{"name":"1M Yang","icon":"💎","type":"yang","amount":1000000,"active":true,"min_qty":1,"max_qty":1,"chance":16.0},{"name":"10M Yang","icon":"🔷","type":"yang","amount":10000000,"active":true,"min_qty":1,"max_qty":1,"chance":10.0},{"name":"100M Yang","icon":"👑","type":"yang","amount":100000000,"active":true,"min_qty":1,"max_qty":1,"chance":5.0},{"name":"1B Yang","icon":"🏦","type":"yang","amount":1000000000,"active":true,"min_qty":1,"max_qty":1,"chance":2.0},{"name":"4B Főnyeremény","icon":"🏆","type":"yang","amount":4000000000,"active":true,"min_qty":1,"max_qty":1,"chance":0.1},{"name":"Ritka PET","icon":"🐾","type":"item","amount":1,"active":true,"min_qty":1,"max_qty":1,"chance":2.0},{"name":"Semmi","icon":"❌","type":"nothing","amount":0,"active":true,"min_qty":1,"max_qty":1,"chance":10.9}];
...
app.post("/api/open",auth,async(req,res)=>{
 ...
 try{
   ...
   const jackpotHits=results.filter(r=>r.name==="4B Főnyeremény").length;
   for(let i=0;i<jackpotHits;i++){
     await client.query(
       "INSERT INTO jackpot_wins(user_id,amount,reward_name) VALUES($1,$2,$3)",
       [req.user.id,10000000000,"4B Főnyeremény"]
     );
   }
